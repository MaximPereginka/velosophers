    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="form-group">
                <a href="/dashboard/moderator/article/{{ $data['article']->id }}/publish" class="form-control btn btn-success" title="Опубликовать">Опубликовать</a>
            </div>
            <div class="form-group">
    ...
    <div id="reject_article" class="modal">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="/dashboard/moderator/article/{{ $data['article']->id }}/reject" method="post">
                    {{ csrf_field() }}
                    {{ method_field("PATCH") }}
