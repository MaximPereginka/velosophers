    ...
    @else
        @foreach($data['article']->comments as $comment)
            <div href="#" class="list-group-item">
                <a href="/dashboard/author/articles/{{ $data['article']->id }}/comments/{{ $comment->id }}/delete" class="close">&times;</a>
                ...
                @if(!$comment->highlighted)
                    <p><a href="/dashboard/author/articles/{{ $data['article']->id }}/comments/{{ $comment->id }}/pin" class="btn btn-xs btn-info">Закрепить</a></p>
                @else
                    <p><a href="/dashboard/author/articles/{{ $data['article']->id }}/comments/{{ $comment->id }}/pin" class="btn btn-xs btn-danger">Открепить</a></p>
                @endif
